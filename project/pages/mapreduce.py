...
if congviec != "Select Task":
    ...
    if congviec == "10 do an co gia cao nhat":
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/doan_top10_maxPrice || true && \
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/doan_top10_minPrice || true && \
        hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/quanan_top10_maxRating || true && \
        hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/avg_price_per_quan || true && \
hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
...
hdfs dfs -cat /user/hadoopnhom3/BigData/output/avg_price_per_quan/part-00000")
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/count_items_per_quan || true && \
hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
...
hdfs dfs -cat /user/hadoopnhom3/BigData/output/count_items_per_quan/part-00000")
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/max_price_per_quan || true && \
hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
...
hdfs dfs -cat /user/hadoopnhom3/BigData/output/max_price_per_quan/part-00000")
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/max_avg_price_quan || true && \
hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
...
hdfs dfs -cat /user/hadoopnhom3/BigData/output/max_avg_price_quan/part-00000")
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/min_avg_price_quan || true && \
hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
-input /user/hadoopnhom3/BigData/output/avg_price_per_quan \
...
hdfs dfs -cat /user/hadoopnhom3/BigData/output/min_avg_price_quan/part-00000")
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/max_items_quan || true && \
hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
...
hdfs dfs -cat /user/hadoopnhom3/BigData/output/max_items_quan/part-00000")
        ...
        query = ("hdfs dfs -rm -r /user/hadoopnhom3/BigData/output/min_items_quan || true && \
hadoop jar /home/hadoopnhom3/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.4.jar \
-input /user/hadoopnhom3/BigData/output/count_items_per_quan \
